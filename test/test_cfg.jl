...
@testset "Writing and loading rules to/from disk" begin
    g₁ = @cfgrammar begin
        Real = |(1:5)
        Real = 6 | 7 | 8
    end
    
    Grammars.store_cfg("toy_cfg_grammar.json", g₁)
    g₂ = Grammars.read_cfg("toy_cfg_grammar.json")
    @test :Real ∈ g₂.types
    @test g₂.rules == collect(1:8)

    # delete file afterwards
    rm("toy_cfg_grammar.json")
end
